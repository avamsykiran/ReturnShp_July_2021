...
public class AuthenticationController {
	...
	private void authenticate(String email, String password) throws D2HException {
		try {
			...
			throw new D2HException("INVALID_CREDENTIALS");
		}
	}

	@PostMapping(value = "/register")
	public ResponseEntity<D2HUser> saveUser(@RequestBody D2HUser user) throws Exception {
		return ResponseEntity.ok(userDetailsService.add(user));
	}
}
